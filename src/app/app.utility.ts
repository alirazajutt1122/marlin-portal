...
export class AppConstants {
 ...
 public static CUSTODIAN_MODEL = false; 
    ...
    public static DEFAULT_VALUE_TRUE = true; public static INV_USERNAME = "";
    ...
    public static equityColor: String = "#2EAC82";
    ...
    lang: any
    public static MSG_CREATE_ACCOUNT : string;
    public static MSG_REQUEST_FORWARD: string;
    public static MSG_RECORD_SAVED: string;
    public static MSG_RECORD_UPDATED: string;
    public static MSG_PAYMENT_SCHEDULE_GENERATED: string;
    public static MSG_RECORD_POSTED: string;
    public static MSG_RECORD_CANCELED: string;
    public static MSG_RECORD_UNPOSTED: string;
    public static MSG_RECORD_REVERSED: string;
    public static MSG_RECORD_CLEARED: string;
    public static MSG_RECORD_PROCESSED: string;
    public static MSG_NO_DATA_FOUND: string;
