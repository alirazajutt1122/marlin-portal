...
export class ReportService {
    ...
    public getAccountHoldingFormat1(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent,mail): any {
        let url = 'reports/account-holding-summary-format1/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + branch + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/mail/' + mail + '/';
        return this.restService.get(true,url);
    }


    public getAccountHoldingFormat2(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent,mail): any {
    ...
    public getAccountHoldingFormat1withEmail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent): any {
        let url = 'email/account-holding-summary-format1/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + branch + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/';
        return this.restService.get(true,url);
    }
    public getAccountHoldingFormat2WithEmail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent): any {
    ...
    public getAccountHoldingwithSMS(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent): any {
        let url = 'sms/account-holding-summary/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + branch + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/';
            return this.restService.get(true,url);
    }
    public getAccountHoldingwithActiveSMS(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent): any {
