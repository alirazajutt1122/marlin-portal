...
export class ApplicationSetupPage implements OnInit, AfterViewInit {
    ...
    password_ExpiryAlerts: Number
    Unsuccessfull_LoginAttempts: Number
   ...
   *********************************/
    ...
    public clearFields() {
        ...
        if (!AppUtility.isEmptyArray(this.languageList)) {
            this.language2TypeId = this.languageList[0].languageCode;
        }
        if (!AppUtility.isEmptyArray(this.languageList)) {
            this.language2FooterTypeId = this.languageList[0].languageCode;
        }
        this.editDetailEquity = false;
        this.deleteDetailEquity = false;
        ...
        if (!AppUtility.isEmpty(data)) {
            ...
            for (let i: number = 0; i < data.participantParams.length; i++) {
                switch (data.participantParams[i].paramId) {
                    case 1:
                        this.selectedItem.reportHeaderLine1 = data.participantParams[i].paramValue;
                        break;

                    case 2:
                        this.selectedItem.reportHeaderLine2 = data.participantParams[i].paramValue;
                        break;

                    case 3:
                        this.selectedItem.reportHeaderLine3 = data.participantParams[i].paramValue;
                        break;

                    case 4:
                        this.selectedItem.reportFooter1 = data.participantParams[i].paramValue;
                        break;

                    case 5:
                        this.selectedItem.reportFooter2 = data.participantParams[i].paramValue;
                        break;
