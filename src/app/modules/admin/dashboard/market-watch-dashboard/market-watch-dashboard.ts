...
export class MarketWatchDashboardCmp implements OnInit, OnDestroy {
    ...
    getHotSymbols() {
        debugger
        this._authService.getAuthSharedData$.pipe(takeUntil(this._unsubscribeAll)).subscribe((data) => {

            let equitiesArr: any = [];
            let bondsArr: any = [];
            let cryptoArr: any = [];
            let commoditiesArr: any = [];
            let realestateArr: any = [];
            let etfArr: any = [];
            this._symbolService.getFavourites(this.userid, AppConstants.exchangeCode).subscribe((res) => {
                ...
                data.map(a => {
                    ...
                    // if (a.assetClass.assetCode == AssetClass.Equity) {
                    //     this.equitySymbols.push(a)
                    // }
                    // if (a.assetClass.assetCode == AssetClass.Bond) {
                    //     this.bondSymbols.push(a)
                    // }
                    // if (a.assetClass.assetCode == AssetClass.ETF) {
                    //     this.etfSymbols.push(a)
                    // }
                    //..............................................................................................................
                });
                // this.equitiesTransactionsDataSource.data = this.equitySymbols
                // this.bondsTransactionsDataSource.data = this.bondSymbols
                // this.etfTransactionsDataSource.data = this.etfSymbols
            })
            data.map(a => {
                ...
                if (a.assetClass.assetCode == AssetClass.Equity) {
                    equitiesArr.push(a)
                } else if (a.assetClass.assetCode == AssetClass.Commodity) {
                    commoditiesArr.push(a)
                } else if (a.assetClass.assetCode == AssetClass.Bond) {
                    bondsArr.push(a)
                } else if (a.assetClass.assetCode == AssetClass.Crypto) {
                    cryptoArr.push(a)
                } else if (a.assetClass.assetCode == AssetClass.RealEstate) {
                    realestateArr.push(a)
                } else if (a.assetClass.assetCode == AssetClass.ETF) {
                    etfArr.push(a)
                }
            ...
            debugger
            this.equitiesTransactionsDataSource.data = equitiesArr
            this.bondsTransactionsDataSource.data = bondsArr
            this.cryptoTransactionsDataSource.data = cryptoArr
            this.commoditiesTransactionsDataSource.data = commoditiesArr
            this.realestateTransactionsDataSource.data = realestateArr
            this.etfTransactionsDataSource.data = etfArr
