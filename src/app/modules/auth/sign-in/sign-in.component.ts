...
export class AuthSignInComponent implements OnInit,OnChanges {
    ...
    constructor(
        ...
        private userService: AuthService2,
    ...
    ngOnInit(): void {
        ...
        this.signUpForm = this._formBuilder.group({
            ...
            mobile: ['', [Validators.required, Validators.pattern("^[1-9][0-9]*$"), Validators.minLength(8), Validators.maxLength(13)]],
    ...
    signUp() {
        ...
        this._authService.signUp(data)
            .subscribe((response) => {
                ...
                // if (this.currentLang == 'pt') {
                //     this.toast.success('Inscreva-se Com Sucesso', 'Sucesso');
                // } else
                //     this.toast.success('Successfully Sign Up', 'Success');
                ...
                let Conflict
                if (response.message.match("NEXUSPSX.USERS_EMAIL_UNIQ") != "") {
                ...
                } else if (response.message == 'Sorry for the inconvenience. Please contact at the support.') {
                    if (this.currentLang == 'pt') {
