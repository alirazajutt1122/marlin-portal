...
export class AuthService2 {
  ...
  public readonly EB_MIGRATORS_TRANSACTIONS_NEW: string = '437';
  public readonly EB_CLIENT_LAST_ACTIVITY_REPORT_VIEW: string = '438';
  public readonly EB_MIGRATORS_CLOSING_RATES_NEW: string = '439';
  public readonly EB_SEC_CLIENT_ACTIVITY_SUMMARY_REPORT_VIEW: string = '440';
  public readonly EB_SEC_CLIENT_ACTIVITY_DETAIL_REPORT_VIEW: string = '441';
  public readonly EB_MIGRATORS_CLIENTS_LOADER_NEW: string = '442';
  public readonly EB_MARGIN_DETAIL_REPORT_VIEW: string = '443';

  public readonly EB_MIGRATORS_AGENT_NEW: string = '444';
  public readonly EB_MIGRATORS_COMMISSION_SALB_NEW: string = '446';
  public readonly EB_PARTICIPANT_RESET_VIEW: string = '445';
  public readonly EB_SYMBOL_DAILY_INDICATOR_NEW: string = '447';
  public readonly EB_SYMBOL_DAILY_INDICATOR_UPDATE: string = '448';
  public readonly EB_SYMBOL_DAILY_INDICATOR_VIEW: string = '449';
  public readonly EB_SHARE_HOLDING_REPORT_VIEW: string = '450';
  public readonly EB_MIGRATORS_FUTURE_OPEN_TRADE_VIEW: string = '451';
  public readonly EB_CLIENT_AGING_REPORT_VIEW: string = '452';
  public readonly EB_MIGRATORS_EXPORT_FILE_REPORT_VIEW: string = '453';
  public readonly EB_RECONCILIATION_CDC_REPORT_VIEW: string = '454';
  public readonly EB_VAULT_CLIENT_PRE_SETTLEMENT_DELIVERY_REPORT_VIEW: string = '455';
  public readonly EB_NET_CAPITAL_BALANCE_VIEW: string = '456';
  public readonly EB_MIGRATORS_CAP_GAIN_TAX_NEW: string = '457';
  public readonly EB_LIQUID_CAPITAL_BALANCE_VIEW: string = '458';
  public readonly EB_CONF_BROADCAST_SMS_VIEW: string = '459';
  public readonly EB_NET_CAPITAL_DETAIL_VIEW: string = '460';
  public readonly EB_MIGRATORS_VAR_AND_SECURITY_HAIRCUT_NEW: string = '461';
  public readonly EB_RECONCILIATION_CLIENTS_CASH_REPORT_VIEW: string = '462';
  public readonly EB_CLIENT_STATUS_REPORT_VIEW: string = '463';
  public readonly EB_MIGRATORS_VOUCHER_NEW: string = '464';
  public readonly EB_MIGRATORS_VAULT_STOCK_DEPOSIT_WITHDRAWL_NEW: string = '465';
  public readonly EB_MIGRATORS_CLIENTS_SETUP_NEW: string = '466';
  public readonly EB_FINANCIALS_VOUCHER_DELETE: string = '467';
  public readonly EB_PLEDGE_RELEASE_REPORT_VIEW: string = '468';
  public readonly EB_IBTS_REPORT_VIEW: string = '469';
  public readonly EB_CLIENT_ASSETS_SEGREGATION_REPORT_VIEW: string = '470';
  public readonly EB_CGT_REPORT_VIEW: string = '471';
  public readonly EB_COMPUTE_AGING_VIEW: string = '472';
  public readonly EB_FINANCIALS_CRT_REPORT_VIEW: string = '473';
  public readonly EB_FINANCIALS_WTA_REPORT_VIEW: string = '474';
  public readonly EB_FINANCIALS_PST_REPORT_VIEW: string = '475';
  public readonly EB_FINANCIALS_COMPLIENCE_RPT_VIEW: string='476';
  ...
  public readonly EB_SRO_NEW: string = '601';
  public readonly EB_SRO_UPDATE: string = '602';
  public readonly EB_SRO_VIEW: string = '603';
  public readonly EB_SRO_DELETE: string = '607';
  public readonly EB_SRO_FILE_NEW: string = '604';
  public readonly EB_SRO_FILE_VIEW: string = '605';

  public readonly EB_SRO_ENTRY_VIEW: string = '606';
  public readonly EB_CONF_AR_NEW: string = '608';
  public readonly EB_CONF_AR_UPDATE: string = '609';
  public readonly EB_CONF_AR_VIEW: string = '610';

  public readonly EB_RDA_CLIENTS_NEW: string = '611';
  public readonly EB_RDA_CLIENTS_UPDATE: string = '612';
  public readonly EB_RDA_CLIENTS_VIEW: string = '613';
  ...
  tradeChange: Subject<string> = new Subject<string>();
  ...
  processToken(res): boolean {
    ...
    if (res.token) {
      // AppUtility.printConsole('response received: ' + JSON.stringify(res));
      ...
      this.socket.on('connect', () => {
        this.socket.emit('authenticate', { token: this.token }) // send the jwt
          .on('authenticated', () => {
          ...
          .on('unauthorized', (error) => {
            ...
            //   console.log("push server: User's token has expired");
            // }
          });
      });
    }
  ...
  isLoggedIn(): boolean {
    this.loggedIn = AppConstants.Loggedin
    return this.loggedIn;
  }
  ...
  isEbAuhtorized(): boolean {
    ...
    return (this.claims.authorities.indexOf(this.EB_EXCHANGE_VIEW) !== -1) ||
      ...
      (this.claims.authorities.indexOf(this.EB_CONF_BROADCAST_SMS_VIEW) !== -1) ||
      ...
      (this.claims.authorities.indexOf(this.EB_CLIENT_LAST_ACTIVITY_REPORT_VIEW) !== -1) ||
