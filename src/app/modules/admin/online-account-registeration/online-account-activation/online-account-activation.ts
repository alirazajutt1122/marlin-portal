...
showDialog(dlg: wjcInput.Popup) {
  ...
  public onDeleteBankAccountAction() {
    ...
    if(AppUtility.isValidVariable(item)) {
      ...
      this.listingService.getInvestorByClientId(invClientId).subscribe(
        restData => {
          ...
          if (AppUtility.isValidVariable(restData[0].clientId)) {
            ...
            if(AppUtility.isValidVariable(restData[0].contactDetail.firstName) && AppUtility.isValidVariable(restData[0].contactDetail.lastName)) {
            ...
            if (restData[0].user != null && restData[0].user.exchange != null) {
