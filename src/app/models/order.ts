...
export class Order
{
    ...
    setOrder(obj): void {
        ...
        this.settlementValue = (AppUtility.isEmpty(obj.settlementValue) ? 0 : Number(obj.settlementValue));
        this.accrudeProfit = (AppUtility.isEmpty(obj.accrudeProfit) ? 0 : Number(obj.accrudeProfit));
