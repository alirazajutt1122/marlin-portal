...
import { NegotiatedEquityOrderComponent } from './negotiated-deals/negotiated-equity-order/negotiated-equity-order';
import { NegotiatedBondOrderComponent } from './negotiated-deals/negotiated-bond-order/negotiated-bond-order';
...
@NgModule({
  ...
  declarations: [
    ...
    NegotiatedEquityOrderComponent,
    NegotiatedBondOrderComponent,
    NegotiatedDealsListComponent,
