...
@Component({
    selector: 'executed-orders',
    templateUrl: './executed-orders.html',
    encapsulation: ViewEncapsulation.None
})
export class ExecutedOrders implements OnInit, AfterViewInit {
...
debugger
    ...
    exportExcel() {
        wjcGridXlsx.FlexGridXlsxConverter.save(this.flexGrid, { includeColumnHeaders: this.includeColumnHeader, includeCellStyles: false }, 'Equities Executed Orders.xlsx');
    }
    ...
    exportPDF() {
        gridPdf.FlexGridPdfConverter.export(this.flexGrid, 'Equities Executed Orders ' + new Date().toLocaleString() + '.pdf', {
            maxPages: 10,
